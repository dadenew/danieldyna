...
class gsp_danieldyna_userindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("fullName"),'title':(message(code: 'user.fullName.label', default: 'Full Name'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
public static final long LAST_MODIFIED = 1389006319857L
